...
export default function FlickreelsSearchBar() {
    ...
    function handleSearch(e: React.FormEvent) {
        ...
        router.push(`/drama/china/channel/flickreels?query=${encodeURIComponent(trimmedQuery)}`)
    }

    function handleReset() {
        setQuery("")
        router.push("/drama/china/channel/flickreels")
    }
